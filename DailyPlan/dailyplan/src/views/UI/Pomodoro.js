export default function Pomodoro_view() {
    return(
        ...
        Pomodoro pro
            ...
            Debe de poder registrar lo del cursor para evitar que el usuario en su descanso use la computadora
            Debe de esperar a que le de un click para pasar al modo de descanso, si pasan... 10 segundos 
            </div>
        </div>
    );
}