...
-- Tiempo de generación: 29-07-2024 a las 20:24:23
...
CREATE TABLE `objectivesblock` (
  ...
  `objblo_check` int DEFAULT NULL,
  `objblo_duration_min` int DEFAULT '5',
  `objblo_durationreal_min` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Volcado de datos para la tabla `usersblocked`
--

INSERT INTO `usersblocked` (`userblocked_id`, `user_id_sourse`, `user_id_target`) VALUES
(2, 53, 54);
...
--
ALTER TABLE `usersblocked`
  MODIFY `userblocked_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
