...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2024 a las 23:08:20
...
CREATE TABLE `alarms` (
  ...
  `alarm_rep_tone` tinyint(4) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `chrono_id`
--

CREATE TABLE `chrono_id` (
  `mark_id` int(11) NOT NULL,
  `chrono_id` varchar(30) DEFAULT NULL,
  `mark_hout` tinyint(4) DEFAULT NULL,
  `mark_min` tinyint(4) DEFAULT NULL,
  `mark_sec` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`user_id`, `user_mail`, `user_name`, `user_password`, `user_number`, `user_status`) VALUES
(1, 'test@gmail.com', 'test', '123', '1234567891', NULL),
(2, 'test1@gmail.com', 'test', '123', '1234567899', 1),
(3, 'oscar@gmail.com', 'Oscar', '321', '3389123123', 1),
(13, 'testTitle@gmail.com', 'testTitle', '123', '3388121212', 1);
...
--
-- Indices de la tabla `chrono_id`
--
ALTER TABLE `chrono_id`
...
--
-- AUTO_INCREMENT de la tabla `chrono_id`
--
ALTER TABLE `chrono_id`
...
--
ALTER TABLE `clocks`
  MODIFY `clock_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
